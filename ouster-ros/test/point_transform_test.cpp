...
class PointTransformTest : public ::testing::Test {
   ...
   protected:
    void SetUp() override {
        ...
        initialize_point_elements_with_randoms<point::size(pt_xyzircaedt)>(pt_xyzircaedt);
...
PointXYZIRCAEDT PointTransformTest::pt_xyzircaedt;
// native point types
...
TEST_F(PointTransformTest, ExpectPointFieldZeroed) {
    ...
    point::transform(pt_xyzircaedt, pt_xyz);
    expect_points_xyz_equal(pt_xyzircaedt, pt_xyz);
    expect_point_fields_zeros<point::size(pt_xyzircaedt)>(pt_xyzircaedt);
...
TEST_F(PointTransformTest, TestTransformReduce_LEGACY) {
    ...
    point::transform(pt_xyzircaedt, pt_legacy);
    expect_points_xyz_equal(pt_xyzircaedt, pt_legacy);
    verify_point_transform(pt_xyzircaedt, pt_legacy);
}
...
TEST_F(PointTransformTest, TestTransformReduce_RNG19_RFL8_SIG16_NIR16_DUAL) {
    ...
    point::transform(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16_dual);
    expect_points_xyz_equal(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16_dual);
    verify_point_transform(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16_dual); 
}
...
TEST_F(PointTransformTest, TestTransformReduce_RNG19_RFL8_SIG16_NIR16) {
    ...
    point::transform(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16);
    expect_points_xyz_equal(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16);
    verify_point_transform(pt_xyzircaedt, pt_rg19_rf8_sg16_nr16);
}
...
TEST_F(PointTransformTest, TestTransformReduce_RNG15_RFL8_NIR8) {
    ...
    point::transform(pt_xyzircaedt, pt_rg15_rfl8_nr8);
    expect_points_xyz_equal(pt_xyzircaedt, pt_rg15_rfl8_nr8);
    verify_point_transform(pt_xyzircaedt, pt_rg15_rfl8_nr8);
}
